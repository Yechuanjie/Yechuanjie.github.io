...
export default defineConfig({
  shortcuts: [
    ...
    [
      ...
      'transition-200 border-1px border-solid border-gray-200 dark:border-dark-500 hover:border-color-[var(--el-color-primary)]'
    ],
    [
      'border-default-hover',
      'transition-200 border-1px border-solid border-gray-200 dark:border-dark-500 hover:(border-gray-300 dark:border-dark-100)'
    ],
    ['border-default-dashed', 'border-2px  border-default border-dashed'],
    [
      'border-default-dashed-hover',
      'transition-200 hover:border-solid hover:border-[var(--el-color-primary)]  border-default-dashed'
    ],
    // 布局
    ...
    [
      'btn-primary-circle',
      'transition-200 cursor-pointer hover:(text-white bg-[var(--el-color-primary)]) h-2.1rem w-2.1rem rounded-full text-center leading-2.1rem border-default'
    ],
    ...
    [
      'btn-primary-border',
      'transition-200 cursor-pointer rounded-4px border-1px border-color-transparent hover:border-color-[var(--el-color-primary)]'
    ],

    ['flex-column', 'flex flex-col'], // flex竖向布局，不居中
    ['flex-middle', 'flex items-center'], // flex横向布局，不居中
    ['flex-center', 'flex items-center justify-center'], // flex横向布局，居中
    ['flex-center-between', 'flex items-center justify-between'], // flex横向布局，居中，两端对齐
    ['flex-column-center', 'flex items-center justify-center flex-col'] // flex竖向布局，居中
  ],
  rules: [],
  theme: {},
  presets: [
