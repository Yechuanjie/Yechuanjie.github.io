  ...
  <div class="mainnavi top" v-if="type === 'top'">
    <ul class="ul">
      ...
      <li
        ...
        @click="choose('tags')"
        :class="{
          on: (page.relativePath == 'pages/tags.md' && selected === '') || selected === 'tags'
        }"
      >
      ...
      <li
        ...
        :class="{
          on: (page.relativePath == 'pages/archives.md' && selected === '') || selected === 'archives'
        }"
      >
  ...
  <div class="mainnavi left" v-else>
    <ul class="ul">
      ...
      <li
        ...
        :class="{
          on: (params.get('category') === key.toString() && selected === '') || selected === key.toString()
        }"
        v-for="(item, key) in data"
      >
        <a class="a" :href="withBase(`/?category=${key.toString()}`)">
          {{ key }}
          <strong class="VPBadge tip strong mini">{{ data[key].length }}</strong>
        </a>
      </li>
    </ul>
    <h4 class="h4">
    ...
    <ul class="ul">
      <li
        ...
        @click="choose('feed')"
        :class="{
          on: (page.relativePath == 'pages/feed.md' && selected === '') || selected === 'feed'
        }"
      >
      ...
      <li
        ...
        @click="choose('tools')"
        :class="{
          on: (page.relativePath == 'pages/tools.md' && selected === '') || selected === 'tools'
        }"
      >
      ...
      <li
        ...
        @click="choose('about')"
        :class="{
          on: (page.relativePath == 'pages/about.md' && selected === '') || selected === 'about'
        }"
      >
